...
class PyramidNet(nn.Module):
    def __init__(self, depth_list, num_classes_list, dataset, alpha, bottleneck=False):
        ...
        if self.dataset.startswith('cifar'):
            ...
            self.conv1  = conv3x3(3, self.input_featuremap_dim)
            ...
            self.bn2 = nn.BatchNorm2d(self.final_featuremap_dim)
    ...
    def _make_layer(self, block_type, blocks, stride=1):
        ...
        layers.append(block_type(self.input_featuremap_dim, int(round(self.featuremap_dim)), stride, downsample))
        ...
        self.input_featuremap_dim = int(round(self.featuremap_dim)) * block_type.outchannel_ratio
